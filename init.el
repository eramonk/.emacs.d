...
;;Window resiz
(global-set-key (kbd "C-c z <left>") 'shrink-window-horizontally)
(global-set-key (kbd "C-c z <right>") 'enlarge-window-horizontally)
(global-set-key (kbd "C-c z <down>") 'shrink-window)
(global-set-key (kbd "C-c z <up>") 'enlarge-window)
